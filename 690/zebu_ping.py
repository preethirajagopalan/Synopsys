...
def main_func():
    my_file = open("/network/scripts/690/zebu_input.txt", "r")
    ...
    keys1 = list2[0].keys()
    with open('/network/scripts/690/zebu_output.txt', 'wb') as output_file1:
    ...
    if OutPut['offline']:
        ...
        SUBJECT = "Ping failed for following 690 Zebu lab devices"
        ...
        TEXT = """\
    			<html>
    			<body>
    			<p>This is an automated email for ICMP/Ping failed zebu devices
    			    <br>
    			    <br>
    			    You are receiving this email alert as zebu_ping.py script has been executed
    			    <br>
    				<br>
