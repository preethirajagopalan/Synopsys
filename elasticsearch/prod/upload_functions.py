            ...
            "mappings": {
                "interface-metrics": {
                    "properties": {
                        ...
                        "lansweeper.asset.type": {"type": "keyword", "normalizer": "lower_case_normalizer"},
...
def get_password():
    ...
    f = open("//network//scripts//elasticsearch//prod//check_test.txt", "r")
    read = f.read()
...
def get_password_ls():
    ...
    # convert from base64 to get the actual value
    f = open("//network//scripts//elasticsearch//prod//check_ls.txt", "r")
    read = f.read()
    return base64.b64decode(read)
...
def get_password_ens():
    ...
    f = open("//network//scripts//elasticsearch//prod//check_ens.txt", "r")
    read = f.read()
    return base64.b64decode(read)
