...
es = Elasticsearch(
    ['elasticeng01', 'elasticeng02'],
    http_auth=('elastic', 'NN^Di@u$7KYs|i1H^H9S'),
    port=9200,
    use_ssl=True,
    ca_certs='../conf/cert/synopsys-ca.pem',
...
me = 'mallikg@synopsys.com'


you = ['mallikg@synopsys.com' ]
...
try:
    ...
    FROM [NetPerfMonUS].[dbo].[InterfaceTraffic_Detail] as a WITH (NOLOCK) 
