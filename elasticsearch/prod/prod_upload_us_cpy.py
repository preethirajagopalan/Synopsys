...
try:
    ...
    a.Out_Maxbps, a.In_Minbps, a.Out_Minbps, a.DateTime, b.InterfaceName,
...
if result:
    ...
    for item in items:
        ...
        if data_dict['datetime']:
            date_time = datetime_to_utc(data_dict['datetime'], code='us')
            data_dict['datetime'] = str(date_time)
