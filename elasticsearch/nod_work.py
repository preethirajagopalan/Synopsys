            ...
            "mappings": {
                "switch-metrics": {
                    "properties": {
                        ...
                        "geoip.location.lat": {"type": "geo_point"},
                        "geoip.location.lon": {"type": "geo_point"},
                        "geoip.location.city": {"type": "geo_point"},
            ...
            "mappings": {
                "switch-metrics": {
                    "properties": {
                        "datetime": {"type": "date",
                                     "format": "yyyy-MM-dd HH:mm:ss.SSSSSS"},
                        "geoip.location.lat": {"type": "geoip"},
                        "geoip.location.lon": {"type": "geoip"},
                        "geoip.location.city": {"type": "geoip"},
                        "node.network-node": {"type": "keyword", "normalizer": "lower_case_normalizer"},
                        "node.vendor": {"type": "keyword", "normalizer": "lower_case_normalizer"},
                        "node.iosversion": {"type": "keyword", "normalizer": "lower_case_normalizer"},
                        "node.machinetype": {"type": "keyword", "normalizer": "lower_case_normalizer"},
