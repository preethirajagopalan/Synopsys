...
for x in final_list:
    if (x['service'] == 'MPLS'):
        if (x['Device'] == 'se80'):
            ...
            result_final.append(dict)
        elif ((x['Device'] == 'ca06' or x['Device'] == 'pl01' or x['Device'] == 'pt02' or x['Device'] == 'tw01' or x['Device'] == 'pt01')):
            dict = {'in_bps': float(x['in_bps']),
                    'out_bps': float(x['out_bps']),
                    'Device': x['Device'],
                    '@timestamp': x['@timestamp'],
            ...
            result_final.append(dict)
        elif (x['Device'] == 'fr65' or x['Device'] == 'tw52' or x['Device'] == 'us03' or x['Device'] == 'us04'):
            dict = {'in_bps': float(x['in_bps']),
                    'out_bps': float(x['out_bps']),
                    'Device': x['Device'],
                    '@timestamp': x['@timestamp'],
            ...
            result_final.append(dict)
        elif ((x['Device'] == 'cn42' or x['Device'] == 'indc' or x['Device'] == 'jp01')):
            dict = {'in_bps': float(x['in_bps']),
                    'out_bps': float(x['out_bps']),
                    'Device': x['Device'],
                    '@timestamp': x['@timestamp'],
