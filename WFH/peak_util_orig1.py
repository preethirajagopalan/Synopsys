...
([NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[DateTime] < getdate() and
[NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[DateTime] > 
DATEADD(minute, -15, FORMAT(getdate(), 'MM/dd/yyyy HH:mm:ss'))) and
...
[NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'46255')""" )
...
[NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[In_Averagebps] is not NULL and
[NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[Out_Averagebps] is not NULL and
([NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'50550' or
[NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'40655' or
[NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'50059' or
...
[NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'50005' or
[NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'40390' or
[NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'50006' or
[NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'50545' or
[NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'50580' or
...
[NetPerfMonInt].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'50002')""" )
...
[NetPerfMonUS].[dbo].[Interfaces].[InterfaceID]
 where
([NetPerfMonUS].[dbo].[InterfaceTraffic_Detail].[DateTime] < getdate() and
[NetPerfMonUS].[dbo].[InterfaceTraffic_Detail].[DateTime] > 
...
[NetPerfMonUS].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'87045')""")
...
[NetPerfMonUS].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'142294' or
[NetPerfMonUS].[dbo].[InterfaceTraffic_Detail].[InterfaceID]=	'142369' or
